...
const projects = [
  ...
  },
  {
    ...
    description:
      "AI-powered research assistant with real-time web search and intelligent response generation. Features bookmark management, conversation export, and real-time streaming.",
  ...
  },
  {
    ...
    description:
      "Real-time video interview platform with automated assessments for students and professionals.",
