...
const logos = [
  ...
  { src: "/tech/kotlin.svg", name: "Kotlin" },
...
export function TechStack() {
  ...
  return (
    <section id="tech" className="py-24 px-6 md:px-12 lg:px-16 max-w-7xl mx-auto">
      {/* HEADING - Tech Arsenal - SAME as Experience */}
      <motion.div 
      ...
      {/* EXACT Experience background - NO special overlay */}
