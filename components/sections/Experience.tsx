...
const experiences = [
  {
    ...
    description: "Developed full-stack e-commerce backend projects with Next.js, Node.js, MongoDB. Built Android apps using Kotlin with Room, Material Components, Firebase. Integrated AI/ML using Python and JavaScript.",
    techStack: ["Next.js", "Kotlin", "MongoDB", "Python", "Firebase", "Node.js"]
  },
  {
    company: "Freelance Projects",
    role: "Full-Stack & AI Developer",
    duration: "2022 - 2023",
    description: "Created social media follower platforms, coin reward systems, AI-powered tools. Managed cloud deployments with MongoDB Atlas and implemented scalable backend APIs.",
  ...
  },
  {
    ...
    description: "Built YouTube coding tutorials, agentic AI experiments, cross-platform apps. Continuous learning in Next.js patterns, TDD, and advanced React.",
...
export function Experience() {
  return (
    <section id="experience" className="py-24 px-6 md:px-12 lg:px-16 max-w-7xl mx-auto">
      {/* Header */}
      <motion.div 
      ...
      <div className="max-w-3xl"> {/* Removed mx-auto to left-align */}
        {experiences.map((exp, index) => (
          ...
          >
            ...
            {/* Content */}
            <div className="space-y-3 opacity-0 animate-in slide-in-from-left-4 duration-500" style={{ opacity: 1 }}>
              {/* Company Header */}
              ...
              {/* Role & Date */}
              <div>
                <h3 className="text-lg lg:text-xl font-semibold text-white">{exp.role}</h3>
              ...
              {/* Description */}
              <p className="text-white/80 leading-relaxed max-w-2xl">{exp.description}</p>
