                  ...
                  <div className="space-y-4 order-2 lg:order-1">
                    ...
                    <div className="flex items-center gap-5 pt-1">
                      ...
                      <Link
                        ...
                        className="ml-auto flex items-center gap-1.5 text-[13px] text-[#666] hover:text-white transition-colors duration-200 group/link"
                      >
                        Read article
            ...
            >
              ...
              {hasFilters && (
                <button
                  ...
                  className="text-[13px] text-[#666] hover:text-white transition-colors duration-150 underline underline-offset-4"
                >
                  Clear filters
                </button>
              )}
